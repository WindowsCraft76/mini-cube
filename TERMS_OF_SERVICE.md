...
MiniCube is a lightweight and open-source **Minecraft launcher** that allows users to download and launch Minecraft versions with a simple interface.

This project is mainly maintained as a personal project and updates are **not guaranteed**.

## 3. Acceptable Use

You agree not to use MiniCube to:
